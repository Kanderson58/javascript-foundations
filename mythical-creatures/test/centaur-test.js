...
describe('Centaur', function() {
  ...
  it('should have a name', function() {
    var meTheCentaur = new Centaur({name: "Kara"})
    var himTheCentaur = new Centaur({name: "Josh"})
    ...
    assert.deepEqual(meTheCentaur.name, "Kara")
    assert.deepEqual(himTheCentaur.name, "Josh")
